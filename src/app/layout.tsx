...
export const metadata: Metadata = {
  ...
  description:
    "Computer Science student from IIT Jodhpur passionate about programming, design, and building creative projects.",
          ...
          <ThemeProvider>
            <div className="relative">
              ...
              <div
                ...
                style={{
                  backgroundImage:
                    "linear-gradient(to right, var(--grid-line) 0.5px, transparent 1px), linear-gradient(to bottom, var(--grid-line) 0.5px, transparent 1px)",
                  backgroundSize: "80px 80px",
                  WebkitMaskImage:
                    "linear-gradient(to right, black 0%, black calc(50% - 576px), transparent calc(50% - 576px), transparent calc(50% + 576px), black calc(50% + 576px), black 100%)",
                  maskImage:
                    "linear-gradient(to right, black 0%, black calc(50% - 576px), transparent calc(50% - 576px), transparent calc(50% + 576px), black calc(50% + 576px), black 100%)",
                }}
              />
              ...
              <div
                className="pointer-events-none fixed inset-y-0 z-[999] hidden xl:block w-px bg-battleship-gray/15"
