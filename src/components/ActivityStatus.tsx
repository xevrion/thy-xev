...
//         {/* <Monitor className="w-4 h-4 text-soft-royal-blue" /> */}
...
//         {/* Keystrokes */}
//         <div className="flex items-center space-x-2">
//           <Keyboard className="w-3 h-3 text-battleship-gray" />
//           <div>
//             <div className="sg-semibold text-silver">{formatNumber(activity.keystrokes)}</div>
//             <div className="inter-regular text-battleship-gray opacity-70">keys</div>
//           </div>
//         </div>
...
//             <div className="flex items-center space-x-2">
//               <Mouse className="w-3 h-3 text-battleship-gray" />
//               <div>
//                 <div className="sg-semibold text-silver">{formatNumber(activity.left_mouse_clicks)}</div>
//                 <div className="inter-regular text-battleship-gray opacity-70">left </div>
//               </div>
//             </div>
//             <div className="flex items-center space-x-2">
//               {/* <Mouse className="w-3 h-3 text-battleship-gray" /> */}
//               <div>
//                 <div className="sg-semibold text-silver">{formatNumber(activity.right_mouse_clicks)}</div>
//                 <div className="inter-regular text-battleship-gray opacity-70">right </div>
//               </div>
//             </div>
//         </div>
//       </div>
...
//       {/* Session Info */}
//       <div className="flex items-center justify-between text-xs text-battleship-gray opacity-70">
//         <span className="inter-regular">Uptime: {activity.session_duration_hours}h</span>
//         {/* <span className="inter-regular">{activity.session_duration_hours}h total</span> */}
//       </div>
//     </div>
//   );
// };
