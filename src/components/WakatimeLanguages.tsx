...
const WakatimeLanguages = () => {
  ...
  if (error || langs.length === 0) {
    return (
      <div className="sg-bold text-[var(--color-text)] text-xl">
  ...
  return (
    <div className="flex flex-col gap-3">
      <p className="sg-bold text-[var(--color-text)] text-xl">Languages this week</p>
      <div className="flex flex-col gap-2 w-full max-w-md">
        {langs.map((lang) => (
          <div key={lang.name} className="flex items-center gap-3">
            {/* Label */}
            <span className="sg-medium text-[var(--color-text)] text-sm w-24 shrink-0 truncate">
              {lang.name}
            </span>
            {/* Bar */}
            ...
            {/* Time */}
            <span className="sg-medium text-[var(--color-text)] text-xs w-12 text-right shrink-0">
