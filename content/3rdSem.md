...
- [fix: swap VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY in .example…](https://github.com/Shashankss1205/CodeGraphContext/pull/261)
- [fix(theme): replace System option with Moon/Sun toggle and set default theme to light](https://github.com/Shashankss1205/CodeGraphContext/pull/263)
- [fix:improve responsiveness for dashboard and navbar](https://github.com/sb-decoder/inquizzitive/pull/119)
- [tests(samples/typescript): add typescript sample_project_typescript](https://github.com/Shashankss1205/CodeGraphContext/pull/298/)
- [Fix heading color inconsistency](https://github.com/Shashankss1205/CodeGraphContext/pull/283)
- [Fix status badge styles for better light mode readability](https://github.com/Shashankss1205/CodeGraphContext/pull/284)
...
- [Motixion](https://github.com/xevrion/Motixion): Live at [Motixion](https://motixion.vercel.app). A minimal, fast, responsive web app that gamifies daily life for accountability partners. Track tasks, hours, points, streaks, and rewards with a shared system. Built with React.js, Tailwind CSS, and Supabase for seamless user experience and real-time data management.
- [StraightHockey](https://github.com/xevrion/StraightHockey): Pygame Air Hockey game featuring Human vs AI with a 5k-step RL agent, custom physics and UI, and an SB3 training pipeline achieving 80%+ win rate.
- [DocuMentor](https://github.com/xevrion/DocuMentor) (Design Credit Project): An offline, privacy-first AI tutor that helps you learn from your study materials through intelligent summarization, Q&A, and quiz generation.
- [Chronapse](https://github.com/xevrion/Chronapse): Chronapse is a Linux-only timelapse recorder that blends the elegance of Go's [Bubbletea](https://github.com/charmbracelet/bubbletea) TUI with the simplicity of Python and OpenCV. It lets you record long-duration timelapses directly from your laptop camera — efficiently, safely, and beautifully.
- [Huffman Compression ](https://github.com/xevrion/Huffman-Compression-DSA-Project)(DSA Course Project): A feature-rich web application implementing the Huffman coding algorithm for both text and image compression. Built with React, Vite, and Tailwind CSS.
- [Shot Ninja](https://github.com/xevrion/shot-ninja): A lightweight, cross-platform screenshot utility that captures your screen with a simple keyboard shortcut. Perfect for quickly saving screenshots during lectures, meetings, or any screen recording session.

Some small contributions to other projects too:
- [feat: Winter theme implementation, Timeline enhancements, and Industry Mentor feature](https://github.com/lakshyajain-0291/Devlup_SOC/pull/3) - Refined DevlUp's SOC website to represent as a Archive for projects and with an amazing theme changing system.
- [Add multi-theme selector with 10 presets and accurate swatches](https://github.com/tsahil01/chat/pull/53) - Adds 10 fully-tokenized themes with persistent NextThemes support, replaces the sidebar toggle with a preview-enabled popover theme switcher, and updates all CSS + toaster logic to correctly follow each theme’s light/dark base.
...
Next plan is, GSoC 2026. I have already started preparing for it by improving my coding skills, learning new technologies, and exploring open-source projects. I am determined to make the most of this opportunity and contribute meaningfully to the open-source community. Let's see how it goes. will keep you all updated.